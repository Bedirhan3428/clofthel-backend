...
try {
  ...
  console.warn('[RegisterScreen] @react-native-google-signin/google-signin not available in current runtime (e.g. Expo Go).');
}
...
export default function RegisterScreen({ navigation }) {
  ...
  const handleGoogleLogin = async () => {
    if (!GoogleSignin) {
      showAlert('Geliştirici Uyarısı', 'Google ile Giriş özelliği standart Expo Go ortamında desteklenmez. Lütfen e-posta/şifre ile kayıt olun veya derlenmiş APK kullanın.');
      return;
    }
